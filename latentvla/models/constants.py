...
elif ROBOT_PLATFORM == "JAKA":
    constants = JAKA_CONSTANTS
...
print("If needed, manually set the correct constants in `latentvla/models/constants.py`!")
