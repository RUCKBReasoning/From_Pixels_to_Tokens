...
OXE_NAMED_MIXTURES: Dict[str, List[Tuple[str, float]]] = {
    ...
    "aloha_click_bell": [
        ("aloha_click_bell",1.0),
    ],
    "aloha_open_laptop": [
        ("aloha_open_laptop",1.0),
    ],
    "aloha_place_bread_basket": [
        ("aloha_place_bread_basket",1.0),
    ],
    "aloha_place_container_plate": [
        ("aloha_place_container_plate",1.0),
    ],
    "aloha_place_mouse_pad": [
        ("aloha_place_mouse_pad",1.0),
    ],
    "aloha_grab_roller": [
        ("aloha_grab_roller",1.0),
    ],
    "aloha_move_pillbottle_pad": [
        ("aloha_move_pillbottle_pad",1.0),
    ],
    "aloha_place_object_stand": [
        ("aloha_place_object_stand",1.0),
    ],
    "aloha_pick_dual_bottles": [
        ("aloha_pick_dual_bottles",1.0),
    ],
}
# fmt: on