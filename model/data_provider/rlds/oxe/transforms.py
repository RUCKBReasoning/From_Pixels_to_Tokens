...
from model.data_provider.rlds.oxe.utils.droid_utils import droid_baseact_transform, droid_finetuning_transform
...
OXE_STANDARDIZATION_TRANSFORMS = {
    ...
    "aloha_lift_pot":aloha_dataset_transform,
    "aloha_click_bell":aloha_dataset_transform,
    "aloha_open_laptop":aloha_dataset_transform,
    "aloha_place_bread_basket":aloha_dataset_transform,
    "aloha_place_container_plate":aloha_dataset_transform,
    "aloha_place_mouse_pad":aloha_dataset_transform,
    "aloha_grab_roller":aloha_dataset_transform,
    "aloha_move_pillbottle_pad":aloha_dataset_transform,
    "aloha_place_object_stand":aloha_dataset_transform,
    "aloha_pick_dual_bottles":aloha_dataset_transform,
